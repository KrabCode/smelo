    ...
    if (selectedPlayer) {
        ...
        if (ci >= 0) {
            ...
            if (maxStreak >= 2 && streakEnd >= 0) {
                var streakLabel = maxStreak + '× série';
            ...
            if (bestWeekIdx >= 0 && bestWeekSum > 0) {
                var bwLabel = 'nej. týden +' + bestWeekSum;
